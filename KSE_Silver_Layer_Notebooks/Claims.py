...
claims_df=spark.read.csv("abfss://landing@kaimurservicesdevdata.dfs.core.windows.net/claims/*.csv",header=True)
...
# MAGIC %sql
# MAGIC select * from  silver.claims where datasource = 'hosb'
