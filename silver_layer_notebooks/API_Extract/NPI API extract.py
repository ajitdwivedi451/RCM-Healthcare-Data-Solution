...
if response.status_code == 200:
    ...
    if detailed_results:
        ...
        display(df)
        df.write.format("parquet").mode("overwrite").save("abfss://bronze@kaimurservicesdevdata.dfs.core.windows.net/npi_extract/")
        df.write.format("delta").mode("overwrite").saveAsTable("ks_dev_databricks.silver.npi_extract")
...
# MAGIC %sql DESCRIBE TABLE ks_dev_databricks.npi_extract;
